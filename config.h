...
static const char col_2[]			= "#585858";
static const char col_3[]			= "#e9d9b9";
static const char col_4[]			= "#000000";
static const char *colors[][3]      = {
    /*               fg     bg     border */
    [SchemeSel]  = { col_3, col_4, col_1, },
    [SchemeNorm] = { col_2, col_4, col_4, },
};
...
static Key keys[] = {
    ...
    { MODKEY,			  XK_f,						spawn,			SHCMD("st -e cfl") },
    ...
    { 0,					XK_Print,				spawn,          SHCMD("scrot ~/Images/screenshots/%Y-%m-%d_%H-%M-%S.png") },
    { MODKEY,				XK_Print,				spawn,          SHCMD("scrot -s ~/Images/screenshots/%Y-%m-%d_%H-%M-%S.png") },
    { MODKEY,				XK_End,					spawn,          SHCMD("shutdown.sh") },
    { MODKEY,				XK_Scroll_Lock,			spawn,          SHCMD("kbdsel") },
